...
<div class="container">
    <div class="row align-items-center">
        <div class="col-md-6">
            ...
            <span class="badge rounded-pill text-black" style="background-color: #f29111;">MySQL</span>
            <span class="badge rounded-pill text-white" style="background-color: #3a6c95">PostgreSQL</span>
            <span class="badge rounded-pill text-black" style="background-color: #787cb5;">PHP</span>
            <span class="badge rounded-pill text-black" style="background-color: #f05340;">Laravel</span>
            <span class="badge rounded-pill text-white" style="background-color: #3c873a;">Node.js</span>
            <span class="badge rounded-pill text-white" style="background-color: #cd6799;">Sass</span>
        </div>
    </div>
</div>
